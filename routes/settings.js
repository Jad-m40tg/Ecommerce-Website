...
const PUBLIC_KEYS = ['store_name', 'store_tagline', 'currency', 'language', 'delivery_fee_cents', 'free_delivery_threshold_cents', 'contact_email', 'contact_phone', 'store_address', 'reviews', 'shipping_policy', 'returns_policy', 'perks_free_delivery', 'perks_warranty_months', 'perks_returns_days', 'announcement_text', 'announcement_enabled', 'offer_banner_url'];
...
const ALLOWED_SETTINGS_KEYS = ['store_name', 'store_tagline', 'currency', 'delivery_fee_cents', 'free_delivery_threshold_cents', 'contact_email', 'contact_phone', 'store_address', 'language', 'shipping_policy', 'returns_policy', 'perks_free_delivery', 'perks_warranty_months', 'perks_returns_days', 'announcement_text', 'announcement_enabled', 'offer_banner_url'];
